...
data_norm = pd.DataFrame.from_csv('norm_update.csv', header=0, index_col=None)
#normalized bootstrapped data from pre-process
data_synthetic = pd.DataFrame.from_csv('synthetic_update.csv', header=0, index_col=None)
...
final.to_csv('shavers_creek_NMF_output.csv', index=False)
print('Done.')
